...
let
  ...
  concatModules = modules: concatStrings (map (module: "\$${module}") modules);
in
{
  home.programs.starship = {
    ...
    settings = {
      ...
      git_status = {
        ...
        deleted = " ";
        style = "bold yellow";
        format = "$conflicted[( $ahead_behind)](bold ${colors.orange})[$deleted$renamed$modified$typechanged$staged$untracked$stashed]($style)";
      };
